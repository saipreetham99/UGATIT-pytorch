...
def parse_args():
    ...
    parser.add_argument(
        "--print_freq", type=int, default=2000, help="The number of image print freq"
    )
    parser.add_argument(
        "--save_freq", type=int, default=2000, help="The number of model save freq"
    )
    parser.add_argument(
    ...
    # New argument for checkpoint sliding window
    parser.add_argument(
        "--checkpoint_window",
        type=int,
        default=3,
        help="Maximum number of recent checkpoints to keep. Set to 0 to keep all.",
    )
...
def check_args(args):
    ...
    # --epoch
    # Note: The original code had an 'epoch' check, but the arg was not defined.
    # The training loop is based on iterations, so this check is removed.
